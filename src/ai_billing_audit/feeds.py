...
CHANGELOG_RELEASES: list[dict] = [
    {
        ...
        "published": datetime.datetime(
            2026, 7, 4, 18, 0, 0, tzinfo=datetime.timezone.utc
        ),
        "summary": (
    ...
    },
    {
        ...
        "published": datetime.datetime(
            2026, 6, 15, 18, 0, 0, tzinfo=datetime.timezone.utc
        ),
        "summary": (
    ...
    },
    {
        ...
        "published": datetime.datetime(
            2026, 5, 1, 18, 0, 0, tzinfo=datetime.timezone.utc
        ),
        "summary": (
    ...
    },
    {
        ...
        "published": datetime.datetime(
            2026, 4, 1, 18, 0, 0, tzinfo=datetime.timezone.utc
        ),
        "summary": (
    ...
    },
    {
        ...
        "published": datetime.datetime(
            2026, 2, 15, 18, 0, 0, tzinfo=datetime.timezone.utc
        ),
        "summary": (
...
def build_atom_feed(host: str) -> str:
    ...
    ET.SubElement(
        feed, "subtitle"
    ).text = "Build notes, AHCIP observations, and release notes from Zorva."
    ...
    ET.SubElement(
        feed,
        "generator",
        uri="https://github.com/camster91/ai-billing-audit",
        version="0.5.0",
    ).text = "Zorva (custom)"
    # Newest first
    entries = sorted(
