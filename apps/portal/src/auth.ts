...
export const authConfig: NextAuthConfig = {
  ...
  // Auth.js must trust the forwarded host when it runs behind Traefik.
  // middleware.ts independently rejects non-canonical production hosts
  // against AUTH_URL before requests reach these handlers.
  trustHost: true,
};
